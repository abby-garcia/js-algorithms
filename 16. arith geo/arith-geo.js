...
// the string "Arithmetic" if the sequence follows an arithmetic 
...
// between each of the numbers is consistent, where as in a 
// geometric sequence, each term after the first is multiplied 
...
// 0 will not be entered, and no array will contain all the 
// same elements. 
...
//arithmetic sequece has an even amount of space in between each number
// if the number before and after a certain number is equal to the 
first number
